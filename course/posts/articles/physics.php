			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<div class="box">
						...
						<header>
						<h3>Announcements <a href="http://revisionupdates.info/course/posts/feeds/physics.rss" class="icon rss circle fa-rss"><span class="label">RSS</span></a></h3>
