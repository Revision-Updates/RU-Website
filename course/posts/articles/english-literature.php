<?php
	$Page_MetaID = 'course';
	$RSS_MetaID = 'english-literature';
	$Course_Title = 'English Literature';
	$Course_Banner = 'englishliterature';
	$Course_Slug = 'english-literature';
	$Course_Icon = 'englit';
			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<div class="box">
						...
						<header>
						<h3>Announcements <a href="http://revisionupdates.info/course/posts/feeds/english-literature.rss" class="icon rss circle fa-rss"><span class="label">RSS</span></a></h3>
