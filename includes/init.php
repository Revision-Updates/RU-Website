...
#Main Author Presets
	if($Course_Lead_AuthorID != "") {
		if($Course_Lead_AuthorID == "1") {
			...
			$Course_Author_Bio = 'Web Developer working <a href="http://sammyherring.co.uk">freelance</a> operating in Kent and CEO of <a href="http://social-servers.co.uk">Social Systems</a>. Studying <a href="http://revisionupdates.info/course/posts/articles/mathematics/">Mathematics</a>, <a href="http://revisionupdates.info/course/posts/articles/further-mathematics/">Further Mathematics</a>, <a href="http://revisionupdates.info/course/posts/articles/physics/">Physics</a> and <a href="http://revisionupdates.info/course/posts/articles/computing/">Computer Science</a>. While working as content director for <a href="https://twitter.com/revisionupdates">@RevisionUpdates</a>.';
			...
			$Course_Author_Bio = 'Hello, I currently attend Homewood School and Sixth Form Centre where I am studying <a href="http://revisionupdates.info/course/posts/articles/biology/">Biology</a>, <a href="http://revisionupdates.info/course/posts/articles/chemistry/">Chemistry</a>, <a href="http://revisionupdates.info/course/posts/articles/physics/">Physics</a> and <a href="http://revisionupdates.info/course/posts/articles/mathematics/">Mathematics</a>. Furthermore, I am a mentor for KS3 students, offering both academic and non-academic guidance. I work with with three brilliant colleagues to coordinate a service to our members, ensuring they get full support with their studies.';
